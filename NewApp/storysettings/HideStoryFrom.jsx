...
const HideStoryScreen = ({navigation}) => {
  return(
    <View style={styles.container}>
      <View style={styles.tabbar}>
        <AntDesign onPress={() => navigation.goBack() } name="arrowleft" color='#000' size={26} style={{ padding: 10}}   />
        <Text style={{color: '#000', fontSize: 20, paddingLeft: 10 }}>Privacy</Text>
      </View>
      <Text style={{color: '#fff'}}>HideStoryScreen</Text>
    </View>
  );
}

export default HideStoryScreen;
